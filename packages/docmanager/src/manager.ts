...
export class DocumentManager implements IDocumentManager {
   ...
   */
  get nameNotebookFileOnLaunch(): boolean {
    return this._nameNotebookFileOnLaunch;
  }

  set nameNotebookFileOnLaunch(value: boolean) {
    this._nameNotebookFileOnLaunch = value;
  }
  ...
  private _nameNotebookFileOnLaunch = true;
